...
export default function AboutPage() {
  ...
  const innovatorsData = [
    {
      ...
      heading: "Crafting Intelligent Solutions That Inspire Innovation",
      description:
        "At JINST, our multidisciplinary team of engineers, designers, and manufacturing experts work together to deliver excellence — from concept to final assembly.",
    },
    {
      name: "Robert",
      role: "Quality Assurance Lead",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop",
      heading: "Ensuring Excellence Through Rigorous Quality Standards",
      description:
        "Our quality assurance team implements comprehensive testing protocols and maintains strict compliance standards to ensure every product meets the highest quality benchmarks.",
    },
    {
      name: "Mary",
      role: "Production Engineer",
      image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop",
      heading: "Optimizing Manufacturing for Maximum Efficiency",
      description:
        "Our production engineering team leverages advanced automation and lean manufacturing principles to deliver cost-effective, scalable solutions without compromising quality.",
    },
  ]
  ...
  const values = [
    {
      ...
      description: "We go beyond satisfaction to deliver impactful results that exceed expectations.",
      gradient: "from-[#0066CC] to-[#00A896]",
    },
    {
      icon: Lightbulb,
      title: "Innovative Solutions",
      description: "Every project is an opportunity to create smarter EMS systems and push boundaries.",
      gradient: "from-[#00A896] to-[#0066CC]",
    },
    {
      icon: Handshake,
      title: "Long-Term Partnerships",
      description: "Building trust-driven relationships that last through consistent excellence.",
      gradient: "from-[#0066CC] to-[#00A896]",
    },
    {
      icon: Award,
      title: "Quality Commitment",
      description: "Every component meets international benchmarks and rigorous quality standards.",
      gradient: "from-[#00A896] to-[#0066CC]",
    },
    {
      icon: Shield,
      title: "Integrity & Transparency",
      description: "Ethical practices are the core of our operations and business relationships.",
      gradient: "from-[#0066CC] to-[#00A896]",
    },
    {
      icon: Users,
      title: "Teamwork & Collaboration",
      description: "Empowering people to achieve collective excellence through collaboration.",
      gradient: "from-[#00A896] to-[#0066CC]",
    },
  ]
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-2xl relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg leading-relaxed text-gray-600 max-w-3xl mx-auto text-pretty">
              We combine expert engineering, certified facilities, and global sourcing to deliver complete product
              development solutions with IP protection and quality assurance.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Our multidisciplinary team of designers, engineers, and prototyping specialists are equipped to take your idea from sketch to market-ready product.",
                details:
                  "We specialize in delivering functional, manufacturable, and user-validated solutions that meet your exact specifications.",
                gradient: "from-[#0066CC] to-[#00A896]",
                color: "#0066CC",
              },
              {
                number: "02",
                icon: Shield,
                title: "Product Privacy & IP Protection",
                description:
                  "We follow a strict confidentiality and NDA-driven workflow to ensure your intellectual property stays safe.",
                details:
                  "From ideation to deployment, your concept remains fully protected with industry-leading security protocols.",
                gradient: "from-[#00A896] to-[#0066CC]",
                color: "#00A896",
              },
              {
                number: "03",
                icon: Award,
                title: "Certified Engineering Facilities",
                description: "We operate out of a certified lab setup tailored for real-world product development:",
                gradient: "from-[#0066CC] to-[#00A896]",
                color: "#0066CC",
                features: [
                  {
                    title: "Advanced Testing Bench",
                    desc: "Performance & compliance validation",
                  },
                  {
                    title: "Wire Harness Development",
                    desc: "Custom wiring solutions",
                  },
                  {
                    title: "PCB Assembly",
                    desc: "In-house SMD & through-hole capabilities",
                  },
                ],
              },
              {
                number: "04",
                icon: Target,
                title: "QC & QA Integrated Processes",
                description: "Comprehensive quality management at every stage of production:",
                gradient: "from-[#00A896] to-[#0066CC]",
                color: "#00A896",
                sections: [
                  {
                    title: "Quality Control (QC)",
                    text: "Ongoing inspection checkpoints for defect-free output",
                  },
                  {
                    title: "Quality Assurance (QA)",
                    text: "Structured frameworks ensuring global standards compliance",
                  },
                ],
              },
              {
                number: "05",
                icon: Zap,
                title: "Product Assembly & Finishing",
                description:
                  "We provide a dedicated Product Assembly Station for final builds, user testing, and DFM optimization.",
                details:
                  "Our assembly process ensures every product meets manufacturing standards and is ready for market deployment.",
                gradient: "from-[#0066CC] to-[#00A896]",
                color: "#0066CC",
              },
              {
                ...
                description:
                  "Our extensive network of vetted suppliers across Asia, Europe, and the Americas enables cost-effective procurement.",
                details:
                  "We deliver high-quality component sourcing with fast turnaround times and competitive pricing.",
                gradient: "from-[#00A896] to-[#0066CC]",
                color: "#00A896",
              },
            ].map((item, index) => {
