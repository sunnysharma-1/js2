        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <nav aria-label="Service tabs" className="hidden sm:flex gap-2">
                {services.map((s, i) => (
                  <button
                    key={s.key}
                    onClick={() => setActiveServiceIndex(i)}
                    className={`px-3 py-1.5 rounded-full text-sm font-medium focus:outline-none focus:ring-2 focus:ring-cyan-300 transition-colors ${
