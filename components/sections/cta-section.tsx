...
export function CTASection() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-slate-950">
      ...
      <div className="relative container mx-auto max-w-4xl px-6 text-center z-10">
        <motion.div
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Scale your electronics manufacturing with a partner trusted by industry leaders.
            We deliver quality, speed, and reliability at every stage.
          </p>
